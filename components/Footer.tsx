    ...
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end gap-4">
              ...
              <a
                href="https://github.com/maxenceleguery"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-gray-800 rounded-lg hover:bg-gray-600 transition-all duration-200 hover:scale-110"
                aria-label="GitHub"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <a
                ...
                className="p-2 bg-gray-800 rounded-lg hover:bg-red-600 transition-all duration-200 hover:scale-110"
                aria-label="Email"
              >
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Maxence Leguéry. Built with Next.js and Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
